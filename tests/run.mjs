...
const FILES = ['./precache.test.mjs', './engagement.test.mjs', './deploy-shape.test.mjs', './rollup.test.mjs', './attribution.test.mjs', './environment.test.mjs', './admin-pwa.test.mjs', './host-routing.test.mjs'];
